...
export const es = {
  ...
  'AGUAS\n' +
  'LITIGIOS\n' +
  'SOLUCIÓN DE CONFLICTOS Y ARBITRAJE\n' +
  'LIBRE COMPETENCIA\n' +
  'CONSTITUCIONAL Y ADMINISTRATIVO\n' +
  'INFORMES ESPECIALIZADOS EN DERECHO\n' +
  ...
  'Contador Auditor (Escuela de Contadores Auditores de Santiago ECAS) (2023), Contador Técnico nivel superior (2018). Postgrado en Gerencia Pública (Instituto de Estudios Fiscales de España (1994)). ' +
  '\n' +
  '\n' +
  'Postgrado en Gestión Tributaria (Universidad Tecnológica Metropolitana (1995)). Diplomado en Tributación de la Empresa (Universidad Adolfo Ibáñez (1998)). Postgrado en Derecho Tributario, (Universidad Salamanca España (1999)). Magíster en Derecho Económico, (Universidad de Chile (1999)). ' +
  '\n' +
  '\n' +
...
'• Miembro de la Comisión Tributaria del Colegio de Contadores de Chile.\n' ,
  ...
  '\n' +
  '\n' +
  '“La Renta y sus nuevos regímenes de tributación (2017)”.  “Otros Impuestos” (2018). Curso de Derecho y Código Tributario – Octava Edición (2020). Delitos Económicos. Todos libros editados por Thomson Reuters. Autor de artículos incorporados en los libros las 3 C en el Sistema Tributario chileno, y Crecer, ambos publicados por la CNC.\n' +
  '\n' +
  '\n' +
  'Otros\n' +
  'Miembro del Consejo Editorial del Manual de Consultas Tributarias de la ANEIICH. Ex miembro del Consejo Superior de la Escuela de Contadores Auditores de Chile. Ex asesor tributario del Colegio de Contadores de Chile. Director de la edición del Código Tributario que realiza Thomson Reuters. Reconocido como especialista desde el año 2010 por Chambers & Partners. \n',
 ...
 [tokens.form.carlosProfessionalAca]:'Actividad Académica: Profesor de Derecho Internacional Privado, Facultad de Derecho, Pontificia Universidad Católica de Chile (1984-). ' +
  ...
  [tokens.form.franciscoEducation]: 'Educación: Facultad de Derecho, Pontificia Universidad Católica de Chile (Licenciado en Derecho con Distinción Máxima, 2014).  ' +
  '\n' +
  '\n' +
  'Diplomado en Planificación Tributaria, Facultad de Economía y Negocios, Universidad de Chile, 2023. ' +
  '\n' +
  '\n' +
  'Curso de Post Grado en Convenios de Doble Imposición. Bruselas, Universidad de Maastricht.',
  [tokens.form.franciscoExperiencePro]: 'Admitido a práctica: 2015.',
  [tokens.form.franciscoProfessionalAca]: 'Actividad Académica: Profesor-Ayudante de Derecho Civil, Pontificia Universidad Católica de Chile (2012-).',
  [tokens.form.franciscoLanguages]: 'Idiomas: Español e inglés.',
  ...
  [tokens.form.carolinaEducation]: 'Educación: Facultad de Derecho, Pontificia Universidad Católica de Chile (Licenciada en Derecho, 1985).\n' +
  'Magíster en Derecho de la Empresa, Pontificia Universidad Católica de Chile 1998 (Tesis: legislación sector forestal); ' +
  '\n' +
   'Post título en Planificación Tributaria, Universidad del Desarrollo, 2010 (Tesis: aspecto tributario del sector forestal).\n  ',

  [tokens.form.carolinaExperiencePro]:'Admitida a práctica: 1986\n' +
  'Otras actividades: Comité RRHH Sofofa; Abogado Jefe y Gerente de Recursos Humanos Grupo CCF (1998-2008).\n' +
  '\n' +
  'Reconocimientos: Mejor Gerente de RRHH del Sector Vitivinícola y del sector Forestal, reconocimiento otorgado por pares y revista Capital 2007.\n',
  ...
  [tokens.headings.Areas]: 'Áreas de Práctica',
    [tokens.nav.fileManager]: 'Archivos',
