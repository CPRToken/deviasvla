...
import { typography , tertiaryFont } from "src/theme/typography";
        ...
        >
          ...
          >
            <Typography
              ...
              variant="subtitle2"
              sx={{
                fontFamily: typography.fontTertiaryFamily, // Apply your custom font family
    ...
    >
      ...
      >
        <Typography
          component="span"
          variant="subtitle1"
          style={{ fontFamily: tertiaryFont.style.fontFamily }}
        >
          {title}
        </Typography>
